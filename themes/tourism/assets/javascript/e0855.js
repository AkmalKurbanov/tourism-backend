...
! function ($, window, document, undefined) {
  ...
  function Plugin(element, options) {
    this.$qlwapp = $(element), this.init(this)
  }
  ...
  $.fn.simulateClick = function () {
    ...
    timeDateToString: function (time) {
      ...
      return 1 === minutes.length && (minutes = "0" + minutes), time.getHours() + ":" + minutes
    },
    ...
    init: function (plugin) {
      ...
      $qlwapp.on("qlwapp.init", (function (e) {
        ...
        var $contact = $(e.target),
          timefrom = $contact.data("timefrom") || !1,
          timeto = $contact.data("timeto") || !1,
          timezone = parseInt($contact.data("timezone")) || 0;
        if (!timeto || !timefrom || timefrom === timeto) return !0;
        var timeCurrent = new Date,
          n, timeZoneOffset = -timeCurrent.getTimezoneOffset() - timezone,
          timeTo = new Date,
          timeFrom = new Date,
          hr, min;
        ...
        $contact.find(".from").text(plugin.timeDateToString(timeFrom)), $contact.find(".to").text(plugin.timeDateToString(timeTo))
      })), $qlwapp.on("qlwapp.pro", (function (e) {
        $qlwapp.find(".qlwapp-toggle").trigger("qlwapp.time"), $qlwapp.find(".qlwapp-account").each((function (i, contact) {
          $(contact).trigger("qlwapp.time")
        }))
      })), $qlwapp.on("qlwapp.resize", (function (e) {
        $(this).hasClass("qlwapp-show") && $(this).trigger("qlwapp.toggle")
      })), $qlwapp.on("qlwapp.init", (function (e) {
        plugin.mobiledevice ? $qlwapp.addClass("mobile").removeClass("desktop") : $qlwapp.addClass("desktop").removeClass("mobile"), $qlwapp.addClass("qlwapp-js-ready")
      })), $qlwapp.on("qlwapp.init", (function (e) {
        $qlwapp.hasClass("qlwapp-premium") && $qlwapp.trigger("qlwapp.pro")
      })), $qlwapp.addClass("qlwapp-js-ready").trigger("qlwapp.init"), $qlwapp.on("qlwapp.height", (function (e) {
        var $container = $(e.delegateTarget),
          $body, $carousel = $container.find(".qlwapp-body").find(".qlwapp-carousel"),
          $header = $container.find(".qlwapp-header"),
          $footer = $container.find(".qlwapp-footer"),
          height = $(window).innerHeight() - $header.outerHeight() - $footer.outerHeight();
        plugin.mobiledevice || (height = .7 * $(window).innerHeight() - $header.outerHeight() - $footer.outerHeight()), $carousel.css({
          "max-height": height + "px"
        })
      })), $qlwapp.on("qlwapp.toggle", (function (e) {
        var $container = $(e.delegateTarget),
          $box = $container.find(".qlwapp-box");
        $container.addClass("qlwapp-transition"), $box.removeClass("response texting"), setTimeout((function () {
        ...
        e.preventDefault(), $(e.delegateTarget).trigger("qlwapp.toggle")
      })), $qlwapp.on("click", "[data-action=open]", (function (e) {
        var url = "https://api.whatsapp.com/send";
        plugin.mobiledevice || (url = "https://web.whatsapp.com/send");
        var $button = $(this),
        ...
        e.preventDefault();
        var $container, $box = $(e.delegateTarget).find(".qlwapp-box");
        $box.addClass("closing"), setTimeout((function () {
          $box.removeClass("response").removeClass("closing"), $box.removeClass("texting")
        }), 300)
        ...
        $box.addClass("response").addClass("opening"), $container.trigger("qlwapp.height"), setTimeout((function () {
        ...
        var $reply = $box.find(".qlwapp-reply"),
          ...
          meta = time ? time + " - " + label : label;
        $reply.data("phone", phone), $avatar.attr("src", avatar), $avatar.attr("alt", name), $number.html(phone), $name.html(name), $label.html(meta), $message.html(message)
        ...
        var $textarea = $(this).find("textarea"),
          ...
          $container, $box = $(e.delegateTarget).find(".qlwapp-box"),
          $buttons = $box.find(".qlwapp-buttons");
        $pre.html($textarea.val()), setTimeout((function () {
          $box.addClass("texting").css({
            "padding-bottom": $pre.outerHeight()
          }), $buttons.addClass("active");
          var message = $textarea.val();
          $reply.data("message", message), "" == message && ($box.removeClass("texting"), $buttons.removeClass("active"))
        }), 300)
      }))
    }
    ...
    return void 0 === options || "object" == typeof options ? this.each((function () {
      $.data(this, "plugin_qlwapp") || $.data(this, "plugin_qlwapp", new Plugin(this, options))
    })) : "string" == typeof options && "_" !== options[0] && "init" !== options ? (this.each((function () {
      var instance = $.data(this, "plugin_qlwapp");
      instance instanceof Plugin && "function" == typeof instance[options] && (returns = instance[options].apply(instance, Array.prototype.slice.call(args, 1))), "destroy" === options && $.data(this, "plugin_qlwapp", null)
    })), void 0 !== returns ? returns : this) : void 0
  }, qlwapp_init(), $(window).on("load", (function () {
    qlwapp_init()
  })), $(window).on("click", (function (e) {
    $(e.target).closest("#qlwapp.qlwapp-show").length || $("div#qlwapp.qlwapp-show").trigger("qlwapp.toggle")
  })), $(window).on("resize", (function (e) {
    $("div#qlwapp").trigger("qlwapp.resize"), $("div#qlwapp").trigger("qlwapp.init")
  }))
...
$('.nav .dropdown-menu').css('opacity', '0');
