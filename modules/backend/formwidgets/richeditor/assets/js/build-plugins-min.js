    ...
    function onInsertFile() {
      new $.oc.mediaManager.popup({
        ...
        onInsert: function (items) {
          ...
          var link, text = editor.selection.text(),
...
(function ($) {
  ...
  RichEditor.prototype.initFroala = function () {
    ...
    froalaOptions.paragraphFormat = this.options.paragraphFormat ? this.options.paragraphFormat : {
      'N': 'Normal',
      'H1': 'Heading 1',
      'H2': 'Heading 2',
      'H3': 'Heading 3',
    ...
    if (this.options.allowEmptyTags) {
      ...
      this.options.allowEmptyTags.split(/[\s,]+/).forEach(function (selector) {
