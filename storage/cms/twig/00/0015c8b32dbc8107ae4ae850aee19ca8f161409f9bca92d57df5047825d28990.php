...
class __TwigTemplate_34a53a5c849c76f51dbb42db4a1a5ce076c5ceaa684dedcedeeb72b7ab5a8988 extends \Twig\Template
{
    ...
    public function __construct(Environment $env)
    {
        ...
        $filters = array("resize" => 2, "media" => 2, "escape" => 10, "page" => 42, "raw" => 69);
        $functions = array();

        try {
            $this->sandbox->checkSecurity(
                ['for', 'partial'],
                ['resize', 'media', 'escape', 'page', 'raw'],
                []
            );
...
";
        // line 69
        echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["records"] ?? null), "items", [], "any", false, false, true, 69), 69, $this->source);
        echo "
    ...
    {
        return array (  177 => 83,  173 => 82,  157 => 69,  145 => 59,  129 => 49,  122 => 45,  116 => 42,  111 => 39,  107 => 38,  76 => 10,  65 => 2,  62 => 1,);
    }
