<?php return [
    ...
    'common' => [
        ...
        'columns' => [
            ...
            'schedule_tours' => 'Расписание туров',
            'faq' => 'Часто задаваемые вопросы',
            'date' => 'Дата',
            'date1' => 'Дата начала тура',
            'date2' => 'Дата завершения тура',
            'review_author_status' => 'Статус автор отзыва',
            'review' => 'Отзыв',
            'tour_cost' => 'Стоимость тура',
            'tour_duration' => 'Продолжительность тура',
            'tour_status' => 'Статус тура',
            'itinerary_desc' => 'Описание маршрута',
            'sights_editor' => 'Редактор достопримечательностей',
            'sights_map' => 'Карта достопримечательностей',
            'itinerary_map' => 'Карта маршрута',
            'url' => 'URL',
