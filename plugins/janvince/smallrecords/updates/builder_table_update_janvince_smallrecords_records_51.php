...
class BuilderTableUpdateJanvinceSmallrecordsRecords51 extends Migration
{
    public function up()
    {
        Schema::table('janvince_smallrecords_records', function($table)
        {
            ...
            $table->text('sights_editor')->default(null)->change();
            $table->string('sights_map', 191)->default(null)->change();
            $table->text('review_author_status')->default(null)->change();
            $table->text('review')->default(null)->change();
            $table->dropColumn('review_author');
    ...
    public function down()
    {
        Schema::table('janvince_smallrecords_records', function($table)
        {
            ...
            $table->text('review_author_status')->default('NULL')->change();
            $table->text('review')->default('NULL')->change();
            $table->text('review_author')->nullable()->default('NULL');
