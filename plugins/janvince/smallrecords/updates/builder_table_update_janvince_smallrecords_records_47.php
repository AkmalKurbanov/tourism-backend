...
class BuilderTableUpdateJanvinceSmallrecordsRecords47 extends Migration
{
    public function up()
    {
        Schema::table('janvince_smallrecords_records', function($table)
        {
            ...
            $table->string('sights_map', 191)->nullable()->change();
    ...
    public function down()
    {
        Schema::table('janvince_smallrecords_records', function($table)
        {
            ...
            $table->text('faq')->default('NULL')->change();
            $table->text('sights_editor')->default('NULL')->change();
            $table->string('sights_map', 191)->nullable(false)->change();
